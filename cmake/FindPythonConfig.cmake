...
if(PYTHONINTERP_FOUND)
  ...
  elseif(WIN32)
    get_filename_component(_Python_Interp_path "${PYTHON_EXECUTABLE}" DIRECTORY)
    string(REGEX REPLACE "[0-9][0-9][0-9]" "310" _Python_Interp_path_310 ${_Python_Interp_path})
    set(PYTHON_COMPILE_FLAGS "/I ${_Python_Interp_path_310}/include")
    set(PYTHON_LINK_FLAGS "${_Python_Interp_path_310}/libs/python310.lib")
  endif (UNIX)
